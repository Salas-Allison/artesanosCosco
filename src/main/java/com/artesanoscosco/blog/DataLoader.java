...
public class DataLoader implements ApplicationRunner
{
    ...
    @Autowired
    public DataLoader(ProduitRepository pproduitRepository, UtilisateurRepository putilisateurRepository)
    {
    ...
    public void run(ApplicationArguments args) throws Exception
    {
        ...
        /*--username = user --*/
        /*--mot_passe = il est generated by Spring Security--*/

        if (mutilisateurRepository.count() == 0)
        {
            ClassPathResource resource = new ClassPathResource("static/json/utilisateurs.json");
            ObjectMapper objectMapper = JsonMapper.builder().addModule(new JavaTimeModule()).build();
